...
1) إذا كانت إجابات الطالب فارغة أو عددها أقل من 3 إجابات،
    فاعتبر أن الامتحان "مقالي (Essay)" ويجب تحليل مستوى الفهم من طبيعة الأسئلة نفسها
    ومن مدى محاولة الطالب الإجابة.

2) إذا كان عدد الأسئلة أكبر بكثير من عدد الإجابات،
    فاعتبر أن الامتحان "مختلط بين مقالي واختياري (Hybrid)".
...
3. وضّح المفاهيم التي يظهر أنه لا يفهمها بعمق (مثل: القوانين الفيزيائية، التحليل الرياضي، فهم الظواهر العلمية، الربط بين المفاهيم).
4. حدد الجزء أو الوحدة التي يجب أن يركز عليها في المنهج الدراسي تحديدًا.
5. اقترح خطة تطوير عملية لتحسين مستواه (طريقة مذاكرة، حل مسائل، مراجعة قوانين، تدريب على التفكير التحليلي).
6. اجعل التحليل عميقًا وتربويًا ومفصلًا.
7. اكتب الإجابة بالكامل باللغة العربية الفصحى الواضحة.
"""
